...
let scoresRpg = rpgGames.reduce((accumulator, game) => {
    return accumulator + game.score;
},0)

let countRpgGames = rpgGames.length;

let mediaRpgGamesScore = scoresRpg / countRpgGames;

console.log(mediaRpgGamesScore);